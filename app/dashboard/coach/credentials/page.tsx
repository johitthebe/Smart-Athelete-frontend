      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage your coaching certifications and documents</p>
          </div>
          <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100">
          <div className="p-6 border-b">
            <h2 className="text-lg font-semibold text-gray-900">Uploaded Credentials</h2>
            <p className="text-sm text-gray-500">{credentials.length} credential{credentials.length !== 1 ? "s" : ""}</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="divide-y">
              {credentials.map((credential) => (
                <div key={credential.id} className="p-4 hover:bg-gray-50 transition">
