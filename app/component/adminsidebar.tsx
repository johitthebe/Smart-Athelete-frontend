...
const navItems = [
  ...
  { href: "/admin/activity",          label: "Activity Tracking", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
  { href: "/admin/coaches/pending",   label: "Pending Coaches", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
  { href: "/admin/exercises",         label: "Exercises",       icon: "M13 10V3L4 14h7v7l9-11h-7z" },
  { href: "/admin/assignments",       label: "Assignments",     icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
  { href: "/admin/benchmarks",        label: "Benchmarks",      icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs" style={{ color: "var(--color-slate)" }}>Admin Panel</p>
        </div>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              style={{
                background: isActive ? "var(--color-navy-light)" : "transparent",
              ...
              onMouseEnter={(e) => {
                if (!isActive) {
                  (e.currentTarget as HTMLAnchorElement).style.background = "var(--color-ice)";
      ...
      >
        ...
        >
          ...
          <div>
            <p className="text-xs font-semibold" style={{ color: "var(--color-navy)" }}>Administrator</p>
